...
function travel_nomad_customize_register( $wp_customize ) {
    ...
    $wp_customize->add_control(
        new Blossom_Travel_Toggle_Control( 
            ...
            array(
                'section'       => 'typography_settings',
                'label'         => __( 'Load Google Fonts Locally', 'travel-nomad' ),
                'description'   => __( 'Enable to load google fonts from your own server instead from google\'s CDN. This solves privacy concerns with Google\'s CDN and their sometimes less-than-transparent policies.', 'travel-nomad' )
            )
        )
    );   
    ...
    $wp_customize->add_control(
        new Blossom_Travel_Toggle_Control( 
            ...
            array(
                'section'       => 'typography_settings',
                'label'         => __( 'Preload Local Fonts', 'travel-nomad' ),
                'description'   => __( 'Preloading Google fonts will speed up your website speed.', 'travel-nomad' ),
    ...
    ob_start(); ?>
        ...
        <span style="margin-bottom: 5px;display: block;"><?php esc_html_e( 'Click the button to reset the local fonts cache', 'travel-nomad' ); ?></span>
        
        <input type="button" class="button button-primary blossom-travel-flush-local-fonts-button" name="blossom-travel-flush-local-fonts-button" value="<?php esc_attr_e( 'Flush Local Font Files', 'travel-nomad' ); ?>" />
    <?php
    $travel_nomad_flush_button = ob_get_clean();
    ...
    $wp_customize->add_control(
        'ed_flush_local_fonts',
        array(
            'label'         => __( 'Flush Local Fonts Cache', 'travel-nomad' ),
            'section'       => 'typography_settings',
            'description'   => $travel_nomad_flush_button,
            'type'          => 'hidden',
            'active_callback' => 'blossom_travel_ed_localgoogle_fonts'
        )
    );
